...
if [[ "x${BENCH_SIZE}" == "x05GB"  ]]; then
BENCH_RUN="./stencil_exe_base.compsys --  512  512 125 50" #
elif [[ "x${BENCH_SIZE}" == "x1GB"  ]]; then
BENCH_RUN="./stencil_exe_base.compsys -- 1024 1024 125 50" #
elif [[ "x${BENCH_SIZE}" == "x4GB"  ]]; then
